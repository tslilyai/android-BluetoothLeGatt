...
import com.microsoft.embeddedsocial.service.handler.BlockCommentUserHandler;
...
import com.microsoft.embeddedsocial.service.handler.UnblockCommentUserHandler;
...
public class IntentProcessorFactory {
	...
	IServiceIntentProcessor createIntentProcessor() {
		...
		processor.registerIntentHandler(ServiceAction.BLOCK_COMMENT_USER, new BlockCommentUserHandler());
		processor.registerIntentHandler(ServiceAction.UNBLOCK_COMMENT_USER, new UnblockCommentUserHandler());
