...
/*
 * Class:     org_mpi_sws_sddr_service_SDDR_Core
 * Method:    c_mallocRadio
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_org_mpi_1sws_sddr_1service_SDDR_1Native_c_1mallocRadio
    ...
    jni_cache.clsRA = (jclass) env->NewGlobalRef(env->FindClass("org/mpi_sws/sddr_service/SDDR_Core$RadioAction"));
    jni_cache.clsAT = (jclass) env->NewGlobalRef(env->FindClass("org/mpi_sws/sddr_service/SDDR_Core$RadioAction$actionType"));
    jni_cache.clsArray = (jclass) env->NewGlobalRef(env->FindClass("java/util/ArrayList"));
    jni_cache.clsNative = (jclass) env->NewGlobalRef(env->FindClass("org/mpi_sws/sddr_service/SDDR_Native"));
    if (!jni_cache.clsAT || !jni_cache.clsRA || !jni_cache.clsArray) {
        LOG_D("c_SDDR", "Class not found");
        assert(0);
    }
    jni_cache.fidChangeEpoch = env->GetStaticFieldID(jni_cache.clsAT, "ChangeEpoch", "Lorg/mpi_sws/sddr_service/SDDR_Core$RadioAction$actionType;");
    jni_cache.fidDiscover = env->GetStaticFieldID(jni_cache.clsAT, "Discover", "Lorg/mpi_sws/sddr_service/SDDR_Core$RadioAction$actionType;");
    ...
    jni_cache.constructorRA = env->GetMethodID(jni_cache.clsRA, "<init>", 
                "(Lorg/mpi_sws/sddr_service/SDDR_Core$RadioAction$actionType;J)V");
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_org_mpi_1sws_sddr_1service_SDDR_1Native_c_1freeRadio
        (JNIEnv *env, jobject obj) {
 ...
 * Signature: ()L
 */
JNIEXPORT jobject JNICALL Java_org_mpi_1sws_sddr_1service_SDDR_1Native_c_1getNextRadioAction
  (JNIEnv *env, jobject obj) {
    SDDRRadio* radioPtr = getRadioPtr(env, obj);
 ...
 * Signature: ()[B
 */
JNIEXPORT jbyteArray JNICALL Java_org_mpi_1sws_sddr_1service_SDDR_1Native_c_1changeAndGetAdvert
  (JNIEnv *env, jobject obj) {
    SDDRRadio* radioPtr = getRadioPtr(env, obj);
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_org_mpi_1sws_sddr_1service_SDDR_1Native_c_1changeEpoch
  (JNIEnv *env, jobject obj) {
    SDDRRadio* radioPtr = getRadioPtr(env, obj);
 ...
 * Signature: ()[B
 */
JNIEXPORT jbyteArray JNICALL Java_org_mpi_1sws_sddr_1service_SDDR_1Native_c_1getRandomAddr
  (JNIEnv *env, jobject obj) {
    SDDRRadio* radioPtr = getRadioPtr(env, obj);
...
/* From class org_mpi_sws_sddr_service_SDDR_1Native */
/*
 * Class:     org_mpi_sws_sddr_service_SDDR_1Native
 * Method:    c_processScanResult
 * Signature: ([BI[B)V
 */
JNIEXPORT void JNICALL Java_org_mpi_1sws_sddr_1service_SDDR_1Native_c_1processScanResult
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_org_mpi_1sws_sddr_1service_SDDR_1Native_c_1preDiscovery
  (JNIEnv *env, jobject obj) {
    SDDRRadio* radioPtr = getRadioPtr(env, obj);
 ...
 * Signature: ()V
 */
 JNIEXPORT void JNICALL Java_org_mpi_1sws_sddr_1service_SDDR_1Native_c_1postDiscovery
  (JNIEnv *env, jobject obj) {
...
JNIEXPORT void JNICALL Java_org_mpi_1sws_sddr_1service_SDDR_1Native_c_1updateLinkability
...
JNIEXPORT jbyteArray JNICALL Java_org_mpi_1sws_sddr_1service_SDDR_1Native_c_1getRetroactiveMatches
        (JNIEnv *env, jobject obj, jbyteArray arr)
{
    jsize len = env->GetArrayLength(arr);
    jbyte* msg = env->GetByteArrayElements(arr,0);
