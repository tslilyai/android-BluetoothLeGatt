...
LOCAL_LDLIBS += $(PROJECT_ROOT)/../jniLibs/armeabi-v7a/libcrypto.so
LOCAL_LDLIBS += $(PROJECT_ROOT)/../jniLibs/armeabi-v7a/libprotobuf.a
LOCAL_LDLIBS += -lc -ldl -llog -landroid

LOCAL_SHARED_LIBRARIES := libprotobuf #libcrypto
